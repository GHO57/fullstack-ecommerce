                    ...
                    <div className="max-w-[1320px] flex flex-col w-full gap-y-[4rem] md:px-8">
                        ...
                        <div className="flex flex-col gap-y-[4rem]">
                            <div className="flex flex-col gap-y-[2rem] w-full border-b-[1px] border-b-lightGray3 pb-[4rem]">
                                <h2 className="heading">Browse By Category</h2>
                                <CategoriesCarousel />
                            </div>
                            <div className="flex flex-col gap-y-[2rem]">
                                <div className="flex items-center justify-between flex-wrap gap-2">
                                    ...
                                    <Link
                                        to="/products"
                                        className="bg-primary text-white px-[1.2rem] py-[0.4rem] border-[1px] border-primary hover:bg-secondary transition-colors duration-100 font-medium rounded-[2px]"
                                    >
                                        View All products
                                    </Link>
                                </div>
                                <div className="flex-center flex-col gap-[3rem] overflow-auto">
                                    <div
                                        ref={ref}
                                        className="flex md:grid lg:grid md:grid-cols-3 lg:grid-cols-4 gap-[1rem]"
                                    >
